...
Canonical workflow schemas live in the private `base/schemas` repository and are
mounted through the `base` submodule in production. The orchestrator validates
